...
const VigilanceRequestReceived = () => {
      ...
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        <DialogContent className="w-[90%] md:max-w-3xl">
          ...
          <div className="grid gap-6 py-6 pt-0 h-full max-h-[calc(100vh-20rem)] overflow-y-scroll">
            ...
            <div>
              <Label>Unit HR Remarks</Label>
              <p className="text-sm text-muted-foreground">{remarks.unitHrRemarks}</p>
            </div>
            <div className="grid gap-2 mt-2">
              <Label htmlFor="vigilanceStatus">Vigilance Status</Label>
              <Textarea
                id="vigilanceStatus"
                value={remarks.vigilanceStatus}
                onChange={handleVigilanceStatusChange}
                className="h-20 mt-1"
              />
            </div>
          </div>
...
export default VigilanceRequestReceived;
