...
import { ChevronRight, FileText, Users, Clock, Shield, CheckCircle, AlertCircle, Building, User } from 'lucide-react';
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-3">
                    ...
                    <Select
                      ...
                      className="text-base"
                      placeholder="Choose the purpose for NOC..."
                      styles={{
                        control: (base) => ({
                          ...base,
                          minHeight: '50px',
                  ...
                  <div className="space-y-3">
                    ...
                    <Select
                      ...
                      options={employees
                        ...
                        .map((emp) => ({
                          label: `${emp.empCode} | ${emp.empName || 'Unknown'} | ${emp.designation} | ${
                            emp.department
                          }`,
                          value: emp.empCode,
                        }))}
                      ...
                      className="text-base"
                      placeholder="Choose employee for NOC..."
                      styles={{
                        control: (base) => ({
                          ...base,
                          minHeight: '50px',
